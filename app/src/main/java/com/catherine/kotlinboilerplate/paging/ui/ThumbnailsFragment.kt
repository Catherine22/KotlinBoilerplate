...
import com.catherine.kotlinboilerplate.paging.ThumbnailAdapter


class ThumbnailsFragment : Fragment(), OnAlbumClickListener {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_thumbnails, container, false)
        val albumList = root.findViewById<RecyclerView>(R.id.rv_thumbnails)
        val adapter = ThumbnailAdapter(this)
        albumList.apply {
            layoutManager = GridLayoutManager(activity, ThumbnailAdapter.NUMBER_OF_COLUMNS)
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): ThumbnailsFragment {
            return ThumbnailsFragment().apply {
